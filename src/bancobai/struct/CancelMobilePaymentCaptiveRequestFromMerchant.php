...
/**
 * This class stands for cancelMobilePaymentCaptiveRequestFromMerchant StructType
 * Meta information extracted from the WSDL
 * - type: tns:cancelMobilePaymentCaptiveRequestFromMerchant
 * @subpackage Structs
 */
class CancelMobilePaymentCaptiveRequestFromMerchant extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for cancelMobilePaymentCaptiveRequestFromMerchant
     * @uses CancelMobilePaymentCaptiveRequestFromMerchant::setExternalReference()
     * @uses CancelMobilePaymentCaptiveRequestFromMerchant::setPaymentId()
     * @uses CancelMobilePaymentCaptiveRequestFromMerchant::setApiKey()
     ...
     * @param string $externalReference
     * @return \StructType\CancelMobilePaymentCaptiveRequestFromMerchant
     */
