...
/**
 * This class stands for ShoppingCartItem StructType
 * @subpackage Structs
 */
class ShoppingCartItem extends AbstractStructBase
{
    /**
     * The amountPerItem
    ...
    /**
     * Constructor method for ShoppingCartItem
     * @uses ShoppingCartItem::setAmountPerItem()
     * @uses ShoppingCartItem::setCount()
     * @uses ShoppingCartItem::setDescription()
     * @uses ShoppingCartItem::setDiscount()
     * @uses ShoppingCartItem::setMetadata()
     * @uses ShoppingCartItem::setTotalAmount()
