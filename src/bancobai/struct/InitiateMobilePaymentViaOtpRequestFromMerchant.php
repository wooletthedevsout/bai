...
/**
 * This class stands for initiateMobilePaymentViaOtpRequestFromMerchant StructType
 * Meta information extracted from the WSDL
 * - type: tns:initiateMobilePaymentViaOtpRequestFromMerchant
 * @subpackage Structs
 */
class InitiateMobilePaymentViaOtpRequestFromMerchant extends AbstractStructBase
{
    /**
     * The customerMsisdn
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for initiateMobilePaymentViaOtpRequestFromMerchant
     * @uses InitiateMobilePaymentViaOtpRequestFromMerchant::setCustomerMsisdn()
     * @uses InitiateMobilePaymentViaOtpRequestFromMerchant::setTotalAmount()
     * @uses InitiateMobilePaymentViaOtpRequestFromMerchant::setCurrency()
     * @uses InitiateMobilePaymentViaOtpRequestFromMerchant::setShoppingCart()
     * @uses InitiateMobilePaymentViaOtpRequestFromMerchant::setExternalReference()
     * @uses InitiateMobilePaymentViaOtpRequestFromMerchant::setDescription()
     * @uses InitiateMobilePaymentViaOtpRequestFromMerchant::setApiKey()
     ...
     * @param string $customerMsisdn
     * @return \BancoBai\Client\Struct\InitiateMobilePaymentViaOtpRequestFromMerchant
     */
