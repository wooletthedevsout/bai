...
/**
 * This class stands for GenerateNewPaymentCaptiveRequestResponse StructType
 * @subpackage Structs
 */
class GenerateNewPaymentCaptiveRequestResponse extends ResponseBase
{
    /**
     * The operationId
    ...
    /**
     * Constructor method for GenerateNewPaymentCaptiveRequestResponse
     * @uses GenerateNewPaymentCaptiveRequestResponse::setOperationId()
     ...
     * @param int $operationId
     * @return \StructType\GenerateNewPaymentCaptiveRequestResponse
     */
