...
/**
 * This class stands for ConfirmPaymentCaptiveRequestResponse StructType
 * @subpackage Structs
 */
class ConfirmPaymentCaptiveRequestResponse extends ResponseBase
{
    /**
     * The operationId
    ...
    /**
     * Constructor method for ConfirmPaymentCaptiveRequestResponse
     * @uses ConfirmPaymentCaptiveRequestResponse::setOperationId()
     ...
     * @param int $operationId
     * @return \StructType\ConfirmPaymentCaptiveRequestResponse
     */
